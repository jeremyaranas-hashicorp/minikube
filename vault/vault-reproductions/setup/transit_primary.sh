...
helm install -n vault vault-auto-unseal hashicorp/vault --values ../helm-chart-values-files/vault-values-auto-unseal-updated.yaml
...
helm install -n vault vault hashicorp/vault --values ../helm-chart-values-files/vault-values-transit-updated.yaml 

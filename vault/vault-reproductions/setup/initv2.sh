...
Current Options
-----------------
1) Vault, Raft, Transit auto-unseal
2) Vault, Raft, Shamir unseal
3) Vault, Raft, Shamir unseal, TLS
4) Vault, Consul, Shamir unseal
-----------------
EOF

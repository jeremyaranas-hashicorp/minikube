...
rm -fr /tmp/vault
./certs.sh
helm upgrade vault hashicorp/vault -f ../helm_chart_value_files/vault-values-tls.yaml -n vault
...
./certs-secondary.sh
helm upgrade vault-secondary hashicorp/vault -f ../helm_chart_value_files/vault-values-secondary-tls.yaml -n vault-secondary
